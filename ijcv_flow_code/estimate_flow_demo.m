...
im1 = imread('D:\Work_LiyueGe\006_科研材料\0010_科研\数据集文献和数据集\001_光流数据集\training\clean\temple_2\frame_0001.png');
im2 = imread('D:\Work_LiyueGe\006_科研材料\0010_科研\数据集文献和数据集\001_光流数据集\training\clean\temple_2\frame_0002.png');
% images = [];
tmp1 = double(rgb2gray(uint8(im1)));
tmp2 = double(rgb2gray(uint8(im2)));
images  = cat(3, tmp1, tmp2);
uv =  readFlowFile('D:\Work_LiyueGe\006_科研材料\0010_科研\数据集文献和数据集\001_光流数据集\training\flow\temple_2\frame_0001.flo');
...
% for i=0:20
%     if i<10
%         flow = readFlowFile(['D:\Work_LiyueGe\006_科研材料\003_实验室\006_史世栋论文\kitti\无遮挡\00000',num2str(i),'_10.flo']);
%     else
%         flow = readFlowFile(['D:\Work_LiyueGe\006_科研材料\003_实验室\006_史世栋论文\kitti\无遮挡\0000',num2str(i),'_10.flo']);
%     end
%     figure(1);
%     imshow(uint8(flowToColor(flow)));
%     if i<10
% %         imwrite(uint8(flowToColor(flow)),['D:\Work_LiyueGe\006_科研材料\003_实验室\006_史世栋论文\kitti\光流\无遮挡\00000',num2str(i),'_10.png']);
%     else
% %          imwrite(uint8(flowToColor(flow)),['D:\Work_LiyueGe\006_科研材料\003_实验室\006_史世栋论文\kitti\光流\无遮挡\0000',num2str(i),'_10.png']);
%     end
%     
% end
